...
import com.mgb.scoreMe.itr.fileDownload.converter.GenInfoAllData.*;
...
//        List<ShareHolderInfo> shareHolderInfoList=ShareHolderInfoConverter.convertToShareHolderInfoList(shareHoldersInfoJson);
        ...
        JsonObject otherFirmsPartnerJson=genInfoJson.get("Other Firms in which the Entity is a Partner").getAsJsonObject();
